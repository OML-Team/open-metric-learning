...
@pytest.mark.parametrize(
    ...
    [
        ({"OVERALL": {"cmc": {1: tensor([0.1, 0.2, 0.0])}}}, {"OVERALL": {"cmc": {1: 0.1}}}),
        ({"cmc": {1: 1}}, {"cmc": {1: 1}}),
        ({"OVERALL": {"cmc": {1: tensor([0.1, 0.2, 0.0])}}, "a": 0.3}, {"OVERALL": {"cmc": {1: 0.1}}, "a": 0.3}),
        (
            {"OVERALL": {"cmc": {1: tensor([0.1, 0.2, 0.0])}}, "a": tensor([0.3, 0.1])},
            {"OVERALL": {"cmc": {1: 0.1}}, "a": 0.2},
        ),
        (
            {"OVERALL": {"cmc": {1: tensor([0.1, 0.2, 0.0])}}, "a": tensor([0.3, 0.1])},
            {"OVERALL": {"cmc": {1: torch.mean(tensor([0.1, 0.2, 0.0]))}}, "a": torch.mean(tensor([0.3, 0.1]))},
        ),
        (
            {"OVERALL": {"cmc": {1: tensor([0.1, 0.2, 0.0])}}, "a": tensor([0.3])},
