...
TRANSFORMS_FOR_PRETRAINED = {
    ...
    "vitb14_dinov2": get_normalisation_resize_hypvit(im_size=256, crop_size=224),
    "vitb14_reg_dinov2": get_normalisation_resize_hypvit(im_size=256, crop_size=224),
    "vitl14_dinov2": get_normalisation_resize_hypvit(im_size=256, crop_size=224),
    "vitl14_reg_dinov2": get_normalisation_resize_hypvit(im_size=256, crop_size=224),
    "vits14_dinov2": get_normalisation_resize_hypvit(im_size=256, crop_size=224),
    "vits14_reg_dinov2": get_normalisation_resize_hypvit(im_size=256, crop_size=224),
