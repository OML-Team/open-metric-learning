...
TRANSFORMS_TORCH = {
    ...
    "augs_random_resized_crop": get_augs_random_resized_crop,
    "norm_resize_center_crop": get_normalisation_resize_center_crop,
...
TRANSFORMS_FOR_PRETRAINED = {
    "resnet50_moco_v2": get_normalisation_resize_center_crop(im_size=256, crop_size=224),
    "resnet18_imagenet1k_v1": get_normalisation_resize_center_crop(im_size=256, crop_size=224),
    "resnet34_imagenet1k_v1": get_normalisation_resize_center_crop(im_size=256, crop_size=224),
    "resnet50_imagenet1k_v1": get_normalisation_resize_center_crop(im_size=256, crop_size=224),
    "resnet101_imagenet1k_v1": get_normalisation_resize_center_crop(im_size=256, crop_size=224),
    "resnet152_imagenet1k_v1": get_normalisation_resize_center_crop(im_size=256, crop_size=224),
    ...
    "vitb14_dinov2": get_normalisation_resize_center_crop(im_size=224),
    "vitb14_reg_dinov2": get_normalisation_resize_center_crop(im_size=224),
    "vitl14_dinov2": get_normalisation_resize_center_crop(im_size=224),
    "vitl14_reg_dinov2": get_normalisation_resize_center_crop(im_size=224),
    "vits14_dinov2": get_normalisation_resize_center_crop(im_size=224),
    "vits14_reg_dinov2": get_normalisation_resize_center_crop(im_size=224),
    ...
    "vits16_inshop": get_normalisation_resize_center_crop(im_size=224, crop_size=224),
    "vits16_sop": get_normalisation_resize_center_crop(im_size=224, crop_size=224),
    "vits16_cars": get_normalisation_resize_albu(im_size=224),
    "vits16_cub": get_normalisation_resize_albu(im_size=224),
    "vits16_224_mlp_384_inshop": get_normalisation_resize_center_crop(im_size=256, crop_size=224),
