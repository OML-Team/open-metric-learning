...
from oml.datasets import get_retrieval_images_datasets
...
def get_retrieval_loaders(cfg: TCfg) -> Tuple[DataLoader, DataLoader, IDatasetWithLabels, IDatasetQueryGallery]:
