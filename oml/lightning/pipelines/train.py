...
from oml.registry.datasets import get_dataset_by_cfg
...
def get_retrieval_loaders(cfg: TCfg) -> Tuple[DataLoader, DataLoader, ILabeledDataset, IQueryGalleryLabeledDataset]:
    ...
    cfg["train_dataset"]["args"]["transform"] = get_transforms_by_cfg(cfg["train_dataset"]["args"]["transform"])
    cfg["valid_dataset"]["args"]["transform"] = get_transforms_by_cfg(cfg["valid_dataset"]["args"]["transform"])

    train_dataset = get_dataset_by_cfg(cfg["train_dataset"], split="train")
    valid_dataset = get_dataset_by_cfg(cfg["valid_dataset"], split="validation")
